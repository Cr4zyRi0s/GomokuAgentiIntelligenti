...
if __name__ == "__main__":
    ai_white = AIPlayer(search_depth=3,version=2, opening_version=2)
    ai_black = AIPlayer(search_depth=5,version=2, opening_version=2)
    human  = HumanPlayer()

    match = Match(ai_black,human,save_match_data=True)
    ...
    advance_turn = lambda x,y : ai_black.play_turn()
    match.gui.add_on_click_callback(advance_turn)
